...
if("FALSE" STREQUAL "TRUE")
  set(base_local_planner_SOURCE_PREFIX /home/rabot/catkin_ws/src/base_local_planner)
  set(base_local_planner_DEVEL_PREFIX /home/rabot/catkin_ws/devel)
  ...
  set(base_local_planner_INSTALL_PREFIX /home/rabot/catkin_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'base_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rabot/catkin_ws/install/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
